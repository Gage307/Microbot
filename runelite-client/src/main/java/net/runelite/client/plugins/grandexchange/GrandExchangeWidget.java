...
public class GrandExchangeWidget
{
	 ...
	 *
	 * @param slot the {@link net.runelite.client.plugins.microbot.util.grandexchange.GrandExchangeSlots} to get the buy button for
	 * @return the {@link Widget} representing the buy button in the specified slot, or {@code null} if unavailable
	 */
	static Widget getOfferBuyButton(net.runelite.client.plugins.microbot.util.grandexchange.GrandExchangeSlots slot)
	{
	 ...
	 *
	 * @param slot the {@link net.runelite.client.plugins.microbot.util.grandexchange.GrandExchangeSlots} to get the sell button for
	 * @return the {@link Widget} representing the sell button in the specified slot, or {@code null} if unavailable
	 */
	static Widget getOfferSellButton(net.runelite.client.plugins.microbot.util.grandexchange.GrandExchangeSlots slot)
	{
	 ...
	 *
	 * @param slot the {@link net.runelite.client.plugins.microbot.util.grandexchange.GrandExchangeSlots} enum value representing the desired slot
	 * @return the {@link Widget} for the specified slot, or {@code null} if the slot is invalid or not found
	 */
	static Widget getSlot(net.runelite.client.plugins.microbot.util.grandexchange.GrandExchangeSlots slot)
	{
		switch (slot)
		{
			case ONE:
	 ...
	 *
	 * @param slot the {@link net.runelite.client.plugins.microbot.util.grandexchange.GrandExchangeSlots} specifying which slot widget to use
