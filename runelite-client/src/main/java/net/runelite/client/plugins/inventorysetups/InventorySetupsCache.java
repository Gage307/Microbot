...
public class InventorySetupsCache
{
	...
	public void addSetup(final net.runelite.client.plugins.microbot.inventorysetups.InventorySetup setup)
	{
	...
	public void updateSetupName(final net.runelite.client.plugins.microbot.inventorysetups.InventorySetup setup, final String newName)
	{
	...
	public void removeSetup(final net.runelite.client.plugins.microbot.inventorysetups.InventorySetup setup)
	{
		inventorySetupNames.remove(setup.getName());
	...
	public void addSetupToSection(final InventorySetupsSection section, final net.runelite.client.plugins.microbot.inventorysetups.InventorySetup setup)
	{
	...
	public void removeSetupFromSection(final InventorySetupsSection section, final net.runelite.client.plugins.microbot.inventorysetups.InventorySetup setup)
	{
	...
	@Getter
	private final Map<String, net.runelite.client.plugins.microbot.inventorysetups.InventorySetup> inventorySetupNames;
