...
public class InventorySetupsQuiverPanel
{
	...
	@Getter
	private net.runelite.client.plugins.microbot.inventorysetups.ui.InventorySetupsSlot quiverSlot;
	...
	InventorySetupsQuiverPanel(final ItemManager itemManager, final MInventorySetupsPlugin plugin)
	{
		...
		quiverSlot = new net.runelite.client.plugins.microbot.inventorysetups.ui.InventorySetupsSlot(ColorScheme.DARKER_GRAY_COLOR, InventorySetupsSlotID.QUIVER, QUIVER_SLOT_IDX);
		net.runelite.client.plugins.microbot.inventorysetups.ui.InventorySetupsSlot.addFuzzyMouseListenerToSlot(plugin, quiverSlot);
		net.runelite.client.plugins.microbot.inventorysetups.ui.InventorySetupsSlot.addStackMouseListenerToSlot(plugin, quiverSlot);
		net.runelite.client.plugins.microbot.inventorysetups.ui.InventorySetupsSlot.addUpdateFromContainerMouseListenerToSlot(plugin, quiverSlot);
		net.runelite.client.plugins.microbot.inventorysetups.ui.InventorySetupsSlot.addUpdateFromSearchMouseListenerToSlot(plugin, quiverSlot, true);
		net.runelite.client.plugins.microbot.inventorysetups.ui.InventorySetupsSlot.addRemoveMouseListenerToSlot(plugin, quiverSlot);
	...
	public void handleQuiverHighlighting(final InventorySetup setup, boolean doesCurrentInventoryHaveQuiver)
	{
		...
		{
			net.runelite.client.plugins.microbot.inventorysetups.ui.InventorySetupsSlot.setSlotImageAndText(itemManager, quiverSlot, setup, setup.getQuiver().get(0));
			...
			else if (doesCurrentInventoryHaveQuiver)
			{
				...
				net.runelite.client.plugins.microbot.inventorysetups.ui.InventorySetupsSlot.highlightSlot(setup, setup.getQuiver().get(indexInSlot), currentQuiverDataInInvEqp.get(indexInSlot), quiverSlot);
			}
			else
			{
